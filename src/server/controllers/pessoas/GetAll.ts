...
import { IQueryPropsGetAllGlobal } from '../../shared/interfaces';

export const getAllValidation = validation(get => ({
    query: get<IQueryPropsGetAllGlobal>(yup.object().shape({
...
export const getAll = async (req: Request<{}, {}, {}, IQueryPropsGetAllGlobal>, res: Response) => {
